...
// (статический текст на всех страницах подтягивается сюда же автоматически через GitHub Actions)
// ═══════════════════════════════════════
var PRICES = {
  // АЛЮМИНИЙ
  aly_perv: 140,   // Первичный
  aly_prof: 116,   // Профиль
  aly_mix:  85,    // Микс
  aly_mot:  85,    // Моторный
  aly_rad:  55,    // Радиатор
  aly_bank: 74,    // Банка
  ...
  // МЕДЬ
  med:       515,  // Медь / медь-микс (готовая цена, без доп. вычетов)
  med_blesk: 530,  // Медь-блеск

  // ЛАТУНЬ
  latun: 300,      // Латунь и радиаторы (-2%)
